      ...
      >
        <div className="relative">
          <img
            ...
            src={blog.image ? blog.image : "./images/front.jpg"}
            alt={blog.title}
          />
        ...
        <div className="p-6 bg-white group-hover:bg-dark group-hover:text-light duration-300 transition">
          <div className="flex justify-between items-start">
            <div className="">
              <h2 className="text-3xl uppercase group-hover:text-crimson transition duration-300 font-brawler font-bold tracking-wide">
          ...
          <div className="text-sm bt-1 border-gray-300  pb-4 leading-5">
            ...
            <p className="article-body">{blog.excerpt}</p>
          </div>
          ...
          <button className="inline-block text-dark group-hover:text-crimson transition duration-300 border-gray-600 group-hover:border-crimson border-t border-b border-dotted cursor-pointer tracking-wider font-gothic text-2xl hover:scale-110 mt-6">
            read full review
          </button>
        </div>
      </article>
